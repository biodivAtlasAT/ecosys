...
bt_Layermode.attr('value','Layermodus auswählen');
...
bt_Layermode.on('click', function () {
    if (chk_lMode === 0) {
        ...
        bt_Layermode.attr('value','Markermodus auswählen');
...
bt_ecosysCB.on('click', function () {
    if (chk_eSys === 0) {
        map.closePopup();
        bt_ecosysCB.attr('value','Ökosystemleistungen schließen');
        bt_ecosysCB.val('Ökosystemleistungen schließen');
        $('.cl_ecosys').css('visibility', 'visible');
    }
    if (chk_eSys === 1) {
        bt_ecosysCB.attr('value','Ökosystemleistungen auswählen');
