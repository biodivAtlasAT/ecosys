...
@Serializable
data class RasterServiceVals(
    val id: Int, val vals: MutableList<RasterServiceVal>, val svg: String, val dim: String,
                             val geoserverLayerName: String?, val geoserverWorkingSpace: String?
)
...
data class RasterServiceVal(
    ...
    @JsonIgnore val geoserverLayerName: String?, @JsonIgnore val geoserverWorkingSpace: String?
    ) {
