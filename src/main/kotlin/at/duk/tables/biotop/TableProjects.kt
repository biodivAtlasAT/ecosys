...
object TableProjects : IntIdTable("bt_projects") {
    ...
    var geoserverWorkspace: Column<String> = varchar("geoserver_workspace", length = 128)
    var geoserverLayer: Column<String> = varchar("geoserver_layer", length = 128)
    var colTypesCode: Column<String> = varchar("col_types_code", length = 64)
    var colSpeciesCode: Column<String> = varchar("col_species_code", length = 64)
