...
object TableProjects : IntIdTable("bt_projects") {
    ...
    var speciesColId: Column<String?> = varchar("species_col_id", length = 64).nullable()
    var speciesColTaxonId: Column<String?> = varchar("species_col_taxon_id", length = 64).nullable()
    var speciesColTaxonName: Column<String?> = varchar("species_col_taxon_name", length = 64).nullable()
